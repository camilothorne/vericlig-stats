...
s1 = "IN"   # preposition
s2 = "CC"   # coordinating conjunction
s3 = "CS"   # subordinating conjunction
# adverbs
s4 = "RB"   # adverb 
s5 = "RBR"  # adverb, compar 
s6 = "RBT"  # adverb, super 
s7 = "RN"   # adverb, nominal
s8 = "RP"   # adverb, particle 
...
class WordProStats:
    ...
    def __init__(self,path,format):
        ...
        self.statTest(self.classstats) # runs a X^2-test
    ...
    def occStats(self,path,format):
        ...
        # plotting
        MyPlot(self.stats,self.classstats,"PEWs", "two") 
    ...
    def fileStats(self,path,fileids):
        ...
        for id in fileids:
            ...
            print "==> PEWs : " + `c1.count` + " cum. word tokens"
            print "==> PEWs : " + `c1.freq` + " rel. freq."
            ####################################################################
            # class 2
            P2 = MyPatts2(pew).P
            N2 = MyPatts2(rest).P
            ...
            print "==> PEWs : " + `c2.count` + " cum. word tokens"
            print "==> PEWs : " + `c2.freq` + " rel. freq."
            ####################################################################
            # class 3
            P3 = MyPatts2(pew).P
            N3 = MyPatts2(rest).P
            ...
            print "==> PEWs : " + `c3.count` + " cum. word tokens"
            print "==> PEWs : " + `c3.freq` + " rel. freq."
            ####################################################################
            filestats = [c1,c2,c3]
            ####################################################################  
    ...
    def statTest(self,classstats):
        ...
        print "---------------------------------------------------"
        print "sam = ",sample1,"\n(PEWs freqs per corpus)"       
        s.myTTest(sample1,0.2)  # one-way t test
        print "---------------------------------------------------"
        print "sam = ",sample1,"\n(PEWs freqs per corpus)"
